...
function manualModes(){
  ...
  return [
    ...
    {id:'manual:zzz:shiyu-2026-08',game:'zzz',title:'Оборона Шиюй',desc:'Текущий цикл Обороны Шиюй. Критический узел версии 3.1.',start:new Date('2026-08-21T04:00:00+04:00'),end:new Date('2026-09-04T21:59:00+04:00'),done:false,source:'manual',category:'mode'},
    {id:'manual:zzz:deadly-assault-2026-08',game:'zzz',title:'Опасный штурм',desc:'Текущий цикл Опасного штурма.',start:new Date('2026-08-14T04:00:00+04:00'),end:new Date('2026-08-27T21:59:00+04:00'),done:false,source:'manual',category:'mode'},
